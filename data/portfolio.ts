...
export const projects: ProjectItem[] = [
  {
    ...
    bullets: [
      "Ran an end-to-end product audit identifying 7 friction points across discovery, filtering, personalization, engagement, and loyalty",
      "Root causes: choice overload, poor content organization, limited personalization, and a friction-heavy recipe experience hurting retention",
      "Proposed cuisine-based filters and persona-driven meal plans to simplify decision-making at the discovery stage",
      "Designed visual recipe instructions and trending discovery to reduce mid-experience drop-off",
      "Built a gamified loyalty + feedback system and personalized gifting to create stronger repeat-usage loops",
      "Net outcome: reduced decision fatigue, improved discoverability, and engagement loops targeting long-term retention",
    ],
  ...
  },
  {
    ...
    bullets: [
      "Reframed the core problem: dating apps lose users not from bad matches — but because users don't feel safe",
      "Getting to Know You Mode — restricts phone and link sharing early; access unlocks gradually as trust builds",
      "Discomfort Detector — flags pressure patterns in conversation and offers a quiet exit (mute, pause, or close) with no confrontation",
      "First Meet Checklist — surfaces nearby public spots, lets users share their plan with a trusted contact, and sets a check-in reminder",
      "Reframed the success metric from 'matches made' to 'safe real-world meetings completed'",
      "Core thesis: psychological safety is a retention lever, not a support feature",
    ],
